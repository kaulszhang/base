PLATFORM_SYS_ROOT       := /android-ndk-r10d/platforms/android-21/arch-x86_64

PLATFORM_INCLUDE_DIRECTORYS     := $(PLATFORM_INCLUDE_DIRECTORYS) /android-ndk-r10d/sources/cxx-stl/gnu-libstdc++/4.9/include                                       
PLATFORM_INCLUDE_DIRECTORYS     := $(PLATFORM_INCLUDE_DIRECTORYS) /android-ndk-r10d/sources/cxx-stl/gnu-libstdc++/4.9/libs/x86_64/include
PLATFORM_LIBRARY_DIRECTORYS     := $(PLATFORM_LIBRARY_DIRECTORYS) /android-ndk-r10d/sources/cxx-stl/gnu-libstdc++/4.9/libs/x86_64


PLATFORM_COMPILE_FLAGS		:= $(PLATFORM_COMPILE_FLAGS) -m64
