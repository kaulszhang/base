PLATFORM_SYS_ROOT		:= /android-ndk-r10d/platforms/android-21/arch-arm64

PLATFORM_INCLUDE_DIRECTORYS     := $(PLATFORM_INCLUDE_DIRECTORYS) /android-ndk-r10d/sources/cxx-stl/gnu-libstdc++/4.9/include
PLATFORM_INCLUDE_DIRECTORYS     := $(PLATFORM_INCLUDE_DIRECTORYS) /android-ndk-r10d/sources/cxx-stl/gnu-libstdc++/4.9/libs/arm64-v8a/include
PLATFORM_LIBRARY_DIRECTORYS	:= $(PLATFORM_LIBRARY_DIRECTORYS) /android-ndk-r10d/sources/cxx-stl/gnu-libstdc++/4.9/libs/arm64-v8a

#PLATFORM_INCLUDE_DIRECTORYS     := $(PLATFORM_INCLUDE_DIRECTORYS) /android-ndk-r10d/sources/cxx-stl/stlport/stlport
#PLATFORM_INCLUDE_DIRECTORYS     := $(PLATFORM_INCLUDE_DIRECTORYS) /android-ndk-r10d/sources/cxx-stl/stlport/libs/arm64-v8a/include
#PLATFORM_LIBRARY_DIRECTORYS	:= $(PLATFORM_LIBRARY_DIRECTORYS) /android-ndk-r10d/sources/cxx-stl/stlport/libs/libs/arm64-v8a
...
PLATFORM_COMPILE_FLAGS		:= $(PLATFORM_COMPILE_FLAGS) -march=armv8-a
...
PLATFORM_DISABLE_FLAGS		:= -lpthread -lrt
